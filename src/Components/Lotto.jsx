 ...
 */
    ...
    const fetchData = async () => {
      try {
        ...
        const playersResponse = await fetch('https://json-server-5tva.onrender.com/players');
        ...
        if (currentPlayer) {
          ...
          await fetch('https://json-server-5tva.onrender.com/players', {
            method: 'POST',
        ...
        const operatorResponse = await fetch('https://json-server-5tva.onrender.com/operator');
      ...
      try {
        ...
        if(player.name!==""){
          ...
          if (player?.id) {
            ...
            await fetch(`https://json-server-5tva.onrender.com/players/${player.id}`, {
              method: 'PUT',
          ...
          await fetch('https://json-server-5tva.onrender.com/operator', {
            method: 'PUT',
 ...
 */
    const checkPlayerExists = async () => {
      try {
        const response = await fetch(`https://json-server-5tva.onrender.com/players?name=${player.name}`);
